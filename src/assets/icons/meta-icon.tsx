...
const MetaIcon: React.FC<MetaProps> = ({
  size = 24,
  color = '',
  className = '',
}) => {
  return (
    ...
    >
      <linearGradient
        ...
        y2="1208.07"
      >
        <stop offset="0" stop-color={color || '#0064e1'} />
        <stop offset=".4" stop-color={color || '#0064e1'} />
        <stop offset=".83" stop-color={color || '#0064e1'} />
        <stop offset="1" stop-color={color || '#0064e1'} />
      </linearGradient>
      <linearGradient
        id="b"
        gradientTransform="matrix(1 0 0 -1 0 2500)"
